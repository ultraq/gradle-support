...
/**
 * Tests to make sure the {@link FluentConfigurationPlugin} will run at a high
 * level.
 *
 * @author Emanuel Rabina
 */
class FluentConfigurationPluginFunctionalTests extends Specification {
	...
	def "Configures a full Groovy project"() {
		given:
			buildFile << """
				plugins {
					id 'groovy'
